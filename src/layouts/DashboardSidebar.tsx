...
export default function DashboardSidebar({
  ...
  const menuItems: MenuItem[] = [
    ...
    { label: "Configurations", icon: <Settings size={20} />, path: "/configuration", groupe: "principal" },
    { label: "Gérer mes données", icon: <Database size={20} />, path: "/data", groupe: "principal" },
